...
import com.qni.imjaewook_qni.api.dto.LoginResponseDTO
import retrofit2.Call
import retrofit2.Callback
import retrofit2.Response

class LoginViewModel : ViewModel() {
    var loginUserLiveData: MutableLiveData<LoginResponseDTO?> = MutableLiveData()
    var logoutUserLiveData: MutableLiveData<Void?> = MutableLiveData()
